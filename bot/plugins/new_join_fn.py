...
async def help_message_f(client, message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates Channel', url='https://HxBots')
                ],
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/HxSupport')
                ],
                [
                    InlineKeyboardButton('Developer', url='https://t.me/Kirodewal'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('Source Code', url='https://github.com/oVoIndia/Video-Compress') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
